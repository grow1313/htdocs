      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-400 mt-2">↑ 12% vs período anterior</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-400 mt-2">↑ 8% vs período anterior</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-400 mt-2">↑ 15% vs período anterior</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <p className="text-sm text-green-600 dark:text-green-400 mt-2">↑ 20% vs período anterior</p>
          </div>
        </div>
